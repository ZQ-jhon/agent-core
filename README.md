...
Implemented routes, generated OpenAPI, approved call envelopes, observability,
and local verification: [A2UI HTTP API guide](docs/a2ui/v1/http-api-v1.md).

冻结的 A2UI Form Profile v1 现提供独立的提交持久化适配层，不影响既有 Agent 文本 API。数据库配置、迁移命令与生产替换边界见 [提交持久化说明](docs/a2ui/v1/submission-persistence.md)。
